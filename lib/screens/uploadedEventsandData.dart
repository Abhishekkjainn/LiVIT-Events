...
import 'package:livit/adminScreens/getRSVPlist.dart';
import 'package:livit/adminScreens/getRegistrations.dart';
...
class UploadedData extends StatelessWidget {
  UploadedData({super.key});
          ...
          return ListView(
            children: snapshot.data!.docs.map((DocumentSnapshot document) {
              ...
              return (snapshot.data!.docs.isEmpty)
                  ...
                  : (data['uploadedBy'] == controller.userEmail)
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              Get.to(() => RSVPDetails(data['rsvpContestants']),
                                  transition: Transition.downToUp);
                            },
                            child: Container(
                              height: 55,
